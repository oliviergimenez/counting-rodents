...
```{r datsmuskrats, out.width="70%", fig.align='center', fig.pos='H', fig.cap="Data. Top removal data. Bottom temperature. DIFFICILE DE FAIRE LA DIFFERENCE AVEC LES DONNEES NON?"}
...
```{r bias, out.width="98%", fig.align='center', fig.pos='H', fig.cap="Relative bias."}
...
```{r pdcoypus, out.width="98%", fig.align='center', fig.pos='H', fig.cap="Posterior abundance."}
...
```{r muskrats, out.width="95%", fig.align='center', fig.pos='H', fig.cap="Muskrats."}
...
I would like to warmly thank Nathalie Vazzoler-Antoine and Tanguy Lebrun for sharing the coypus data, and the team LIFE MICA for sharing the muskrats data. 
...
This work was funded by a grant from the University of Montpellier through its ExposUM institute.
